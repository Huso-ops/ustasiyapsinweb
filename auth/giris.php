        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-header bg-transparent pb-5">
              <div class="text-muted text-center mt-2 mb-3"><small>Hizmet veren misiniz?</small></div>
              <div class="btn-wrapper text-center">           
                              
                  <a href="giris-bussines.php" class="btn btn-neutral btn-icon">
                    <span class="btn-inner--text">Hizmet Veren Girişi</span>
                  </a>
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form">
                ...
                <div class="text-center">
                  <button type="button" class="btn btn-primary my-4">Giriş Yap</button>
                </div>
              </form>
            </div>
          </div>
          <div class="row mt-3">
            ...
            <div class="col-6 text-right">
              <a href="kayit-ol.php" class="text-light"><small>Hesap oluştur</small></a>
            </div>
          </div>
        </div>
      </div>
