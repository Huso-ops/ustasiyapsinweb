        ...
        <div class="col-lg-6 col-md-8">
          <div class="card bg-secondary border-0">
            <div class="card-header bg-transparent pb-5">
              <div class="text-muted text-center mt-2 mb-4"><small>Hizmet veren misiniz?</small></div>
              <div class="text-center">
                
                <a href="kayit-ol-bussines.php" class="btn btn-neutral btn-icon">
                  <span class="btn-inner--text">Hizmet Veren Olarak Kayıt Ol</span>
            ...
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-muted mb-4">
                <small>Kayıt olabilmek için formu eksiksiz doldurunuz.</small>
              </div>
              <form role="form">
                ...
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Gsm Numaranız" type="passwordagain">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Şifrenizi Oluşturun" type="password">
                  </div>
                </div>
